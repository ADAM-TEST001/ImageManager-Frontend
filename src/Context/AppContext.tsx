...
export const AppContextProvider: FC<AppContextProps> = ({ children }) => {
    ...
    const getAllImages = async () => {
        try {
            ...
            const response = await axios.get("https://server-topaz-seven-37.vercel.app/api/allImages")
    ...
    const handleTitleUpdate = async () => {
        try {
            ...
            await axios.put(`https://server-topaz-seven-37.vercel.app/api/image/${selectedImageId}`, payload)
    ...
    const handleImageDelete = async () => {
        try {
            ...
            await axios.delete(`https://server-topaz-seven-37.vercel.app/api/image/${selectedImageId}`)
